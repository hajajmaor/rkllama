...
logger = logging.getLogger("rkllama.audio.omniasr")
...
class OmniCtcSTTModelRKNN:
    ...
    def get_transcription(self,audio_bytes,language) -> str:
        ...
        chunks, chunks_len = self.split_audio(samples)
        ...
        transcription = "".join(self.tokens[i] for i in all_ids)
